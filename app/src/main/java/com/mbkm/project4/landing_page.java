...
public class landing_page extends AppCompatActivity {
    ...
    TextView logout, profile, orderlist, bus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recentsDataList.add(new RecentData("Sam Poo Kong","Indonesia","Dimulai dari Rp 20.000",R.drawable.sampokong));
        recentsDataList.add(new RecentData("Coban Sewu","Indonesia","Dimulai dari Rp 10.000",R.drawable.bromo));
